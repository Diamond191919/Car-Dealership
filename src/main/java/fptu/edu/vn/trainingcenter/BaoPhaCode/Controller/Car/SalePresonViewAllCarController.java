...
@WebServlet(urlPatterns = {"/sale/view-all-car"})
public class SalePresonViewAllCarController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ArrayList<Car> listCar = cd.getAllCar();
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<h2>Danh sách xe có sẵn VIEW ALL CAR</h2>");
            out.print("<table>");
        ...
        // trong do ListCar la danh sach tra ve tat ca cac xe trong database
