...
public class UpdateCusServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String stringCustID =  (String) request.getAttribute("custID");
        ...
        long custID = Long.parseLong(stringCustID);
        try (PrintWriter out = response.getWriter()) {
            
            Customer uCus = new Customer(custID, custName, phone, sex, cusAddress);
            ...
            request.getRequestDispatcher("Action?action=UpdateCus").forward(request, response);
